...
COMMUNITY_CHANNEL = os.environ.get("COMMUNITY_CHANNEL", "welcome")
MODERATOR_CHANNEL = os.environ.get("MODERATOR_CHANNEL", "admins")
OPS_CHANNEL = os.environ.get("OPS_CHANNEL", "vetsec-ops")
...
PYBOT_ENV = os.environ.get("PYBOT_ENV", "dev")      # Needs to be set to PRODUCTION
BACKEND_URL = os.environ.get("BACKEND_URL", "null") #"https://api.operationcode.org")        # Need to change this
BACKEND_USERNAME = os.environ.get("BACKEND_USERNAME", "Pybot@test.test")
BACKEND_PASS = os.environ.get("BACKEND_PASS", "fakePassword")

BOT_URL = "https://github.com/VetSec/operationcode-pybot"
